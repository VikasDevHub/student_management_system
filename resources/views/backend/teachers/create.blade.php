                ...
                <form action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row my-4">
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="phone_no" placeholder="Your Phone" name="phone_no" value="{{ old('phone_no') }}">
                            ...
                            <div class="col-12 mb-4">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Address" id="floatingTextarea" style="height: 100px;" name="address">{{ old('address') }}</textarea>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingCity" placeholder="City" name="city" value="{{ old('city') }}">
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="dist" placeholder="Dist" name="dist" value="{{ old('dist') }}">
